...
Ranking of the methods was performed as in Fig 1 and described in the methods section using all the datasets with a pertubation strength greater than zero. Where needed imputation of missing values was performed as previously described using only datasets with the same pertubation strength and fold change distribution. ATACseqTFEA was excluded for runtime reasons and diffTF could not be run on two of the datasets.
...
res[,precision:=fifelse(FDR>0 & effect_strength==0 & type=="sim", 0, precision)]
