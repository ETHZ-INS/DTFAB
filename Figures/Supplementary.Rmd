...
The motifs/TFs are ranked for each method, and for each k=1:100 the proportion of 
top k TFs that are part of the known network of the true TF is computed. 
