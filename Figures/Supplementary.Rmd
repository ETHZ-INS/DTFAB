...
# median(sapply(split(res2,res2$dataset), FUN=function(x){
#     cor(x$rank, x$relAUC, use="pairwise")
# }), na.rm=TRUE)
# cor(res2$rank, res2$relAUC, use="pairwise")
...
ranks and network score is -0.61, and the median correlation across datasets is -0.76.
...
**A:** Comparison of the rank of the true motif obtained by the top method of each 
family of approaches, when using peaks called from nucleosome-free fragments 
(but counting all fragments overlapping them).
**B:** Comparison of the rank of the true motif obtained by the top method of each 
family of approaches, when using only nucleosome-free fragments.
**C:** Comparison of the rank of the true true motif obtained by the top method of each 
