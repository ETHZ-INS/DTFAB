...
p1 <- ggplot(bml2, aes(reorder(method,-sqrt(rank)), reorder(dataset, -sqrt(rank)), fill=sqrt(rank), label=rank)) + geom_tile() + 
...
plot_grid(p1, sensFDRplot(bml2) + coord_cartesian(ylim=c(0,0.65), xlim=c(0,1), expand=FALSE),
