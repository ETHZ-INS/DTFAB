...
rtplot <- runtimePlot2(res2) + annotate("text", x=1200, y="diffTF", label=">>days") +
...
fig <- cowplot::plot_grid(
  h,
  plot_grid(sensFDRplot(res2) + ggtitle("At nominal p.adjust <= 0.5"), rtplot, labels=LETTERS[2:3], nrow=1, scale=0.95, rel_widths=c(4,3.5)),
...
```{r}
pdf("Figure1.pdf", width=9, height=10)
fig
dev.off()
```
